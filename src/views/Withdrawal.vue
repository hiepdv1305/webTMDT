...
import MBBank from '../assets/bankaccount/mb.json'
import acb from '../assets/bankaccount/acb.json'
    ...
    async create () {
      ...
      switch (this.schema.bankName) {
        ...
        case 'tpbank':
          ...
          break
        case 'acb':
          this.currentBankAccount = this.acb
          break
        case 'MBBank':
          this.currentBankAccount = this.MBBank
          break
        default:
