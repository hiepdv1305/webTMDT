        ...
        <div id="page" class="hfeed site">
            ...
            <div id="content" class="site-content" tabindex="-1">
                <div class="container">
                    ...
                    <nav class="woocommerce-breadcrumb" ><a href="home.html">Trang chủ</a><span class="delimiter"><i class="fa fa-angle-right"></i></span>Điện thoại &amp; Máy tính bảng</nav>
                    ...
                    <div id="sidebar" class="sidebar" role="complementary">
                        <aside class="widget woocommerce widget_product_categories electro_widget_product_categories">
                                    ...
                                    <ul>
                                        <li class="cat-item current-cat"><a href="product-category.html">Máy quay phim &amp; Máy ảnh</a> <span class="count">(5)</span></li>
                                        <li class="cat-item current-cat"><a href="product-category.html">Điện thoại &amp; Máy tính bảng</a> <span class="count">(20)</span></li>
                                        <li class="cat-item current-cat"><a href="product-category.html">TV &amp; Audio</a> <span class="count">(1)</span></li>
                                        <li class="cat-item current-cat"><a href="product-category.html">Printers &amp; Ink</a> <span class="count">(1)</span></li>
                        ...
                        <aside class="widget widget_electro_products_filter">
                            ...
                            <aside class="widget woocommerce widget_layered_nav">
                                ...
                                <p class="maxlist-more"><a href="#">+ Hiển thị thêm</a></p>
                            </aside>
                            <aside class="widget woocommerce widget_layered_nav">
                                ...
                                <form action="#">
                                    <div class="price_slider_wrapper">
                                        ...
                                        <div class="price_slider_amount">
                                            <a href="#" class="button">Lọc</a>
                                            <div style="" class="price_label">Giá: <span class="from">$428</span> &mdash; <span class="to">$3485</span></div>
                                            <div class="clear"></div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <aside class="widget widget_products">
                            ...
                            <ul class="product_list_widget">
                                <li>
                                    <a href="/event" title="Notebook Black Spire V Nitro  VN7-591G">
                                ...
                                <li>
                                    <a href="/event" title="Tablet Thin EliteBook  Revolve 810 G6">
                                ...
                                <li>
                                    <a href="/event" title="Notebook Widescreen Z51-70  40K6013UPB">
                                ...
                                <li>
                                    <a href="/event" title="Notebook Purple G952VX-T7008T">
