            ...
            <div class="container notification-container">
                <nav>
                    <ul id="menu-top-bar-right" class="nav nav-inline pull-right animate-dropdown flip">
                        <li class="menu-item"><router-link to="/withdrawal"><button class=""><span>Rút
                                        tiền</span></button></router-link></li>
                        <li class="menu-item"><router-link to="/rechange"><button class="action_button"><span>Nạp
                                        tiền</span></button></router-link></li>
                        <li class="menu-item"><span><b>{{ userInfo.amout }}</b></span></li>
                        ...
                        <li v-if="!user" class="menu-item animate-dropdown"><a title="My Account" href="/login"><i
                                    class="ec ec-user"></i>Đăng nhập/Đăng ký</a></li>
                        <li v-else class="menu-item animate-dropdown"><a title="My Account" href="/profile"><i
                                    class="ec ec-user"></i><b>{{ user.username }}</b></a></li>
                    </ul>
                </nav>
                <div v-if="showNoti" class="notification">
                    <div class="notification-body" id="style">
                        ...
                        <div v-for="(item, index) in notification" :key="index"
                            ...
                            <p><a :href="`/event/` + item.eventId" style="color: #333e48; text-align: justify">{{
                                item.content.slice(0, 70) }}</a></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="collapse navbar-toggleable-xs" id="default-header">
                            <nav>
                                <ul id="menu-main-menu" class="nav nav-inline yamm">
                                    <li class="menu-item menu-item-has-children animate-dropdown dropdown"><a
                                            title="Home" href="/">Trang chủ</a>
                                    </li>
                                    <li class="menu-item animate-dropdown"><a title="About Us" href="/winner">Trúng
                                            thưởng</a></li>
                                    <li class="yamm-fw menu-item menu-item-has-children animate-dropdown dropdown">
                                        <a title="Pages" href="#">Hỏi đáp</a>
                                    </li>
                                    <li class="menu-item"><a title="Features" href="#">Tin tức</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="handheld-navigation-wrapper " :class="{ toggled: click }">
                        ...
                        <div class="handheld-navigation hidden-lg-up" id="default-hh-header">
                            ...
                            <ul id="menu-all-departments-menu-1" class="nav nav-inline yamm">
                                ...
                                <li class="highlight menu-item animate-dropdown ">
                                    <a title="Sự kiện của bạn" href="/cart">Sự kiện của bạn</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <ul class="nav navbar-nav departments-menu animate-dropdown">
                    <li class="nav-item dropdown ">
                        <ul id="menu-vertical-menu" class="dropdown-menu yamm departments-menu-dropdown">
                            <li class="highlight menu-item animate-dropdown active"><a title="Value of the Day"
                                    href="product-category.html">Value of the Day</a></li>
                            <li class="highlight menu-item animate-dropdown"><a title="Top 100 Offers"
                                    href="home-v3.html">Top 100 Offers</a></li>
                            <li class="highlight menu-item animate-dropdown"><a title="New Arrivals"
                                    href="home-v3-full-color-background.html">New Arrivals</a></li>

                            <li
                                class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2584 dropdown">
                                <a title="Computers &amp; Accessories" href="product-category.html"
                                    data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Computers &#038;
                                    Accessories</a>
                                                                ...
                                                                <div class="wpb_wrapper">
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="#">Laptops, Desktops &amp;
                                                                                Monitors</a></li>
                                                                        <li><a href="#">Pen Drives, Hard Drives &amp;
                                                                                Memory Cards</a></li>
                                                                        <li><a href="#">Printers &amp; Ink</a></li>
                                                                        <li><a href="#">Networking &amp; Internet
                                                                                Devices</a></li>
                                                                        <li><a href="#">Computer Accessories</a></li>
                                                                        <li><a href="#">Software</a></li>
                                                                        <li class="nav-divider"></li>
                                                                        <li><a href="#"><span class="nav-text">All
                                                                                    Electronics</span><span
                                                                                    class="nav-subtext">Discover more
                                                                                    products</span></a></li>
                                                                    </ul>
                                                            ...
                                                            <div class="wpb_text_column wpb_content_element ">
                                                                <div class="wpb_wrapper">
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="#">All Office &amp; Stationery</a>
                                                                        </li>
                            ...
                            <li
                                ...
                                <a title="Cameras, Audio &amp; Video" href="product-category.html"
                                    data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Cameras, Audio
                                    &#038; Video</a>
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="menu-item animate-dropdown menu-item-object-static_block">
                                        <div class="yamm-content">
                            ...
                            <li
                                class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2586 dropdown">
                                <a title="Mobiles &amp; Tablets" href="product-category.html" data-toggle="dropdown"
                            ...
                            <li
                                class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2587 dropdown">
                                <a title="Movies, Music &amp; Video Games" href="product-category.html"
                                    data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Movies, Music
                                    &#038; Video Games</a>
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="menu-item animate-dropdown menu-item-object-static_block">
                                        <div class="yamm-content">
                            ...
                            <li
                                class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2588 dropdown">
                                <a title="TV &amp; Audio" href="product-category.html" data-toggle="dropdown"
                            ...
                            <li
                                class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2589 dropdown">

                                <a title="Watches &amp; Eyewear" href="product-category.html" data-toggle="dropdown"
                            ...
                            <li
                                class="yamm-tfw menu-item menu-item-has-children animate-dropdown menu-item-2590 dropdown">

                                <a title="Car, Motorbike &amp; Industrial" href="product-category.html"
                                    data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Car, Motorbike
                                    &#038; Industrial</a>
                                <ul role="menu" class=" dropdown-menu">
                                    <li class="menu-item animate-dropdown menu-item-object-static_block">
                                        <div class="yamm-content">
                            ...
                            <li class="menu-item animate-dropdown"><a title="Accessories"
                                    href="product-category.html">Accessories</a></li>
                            <li class="menu-item animate-dropdown"><a title="Printers &amp; Ink"
                                    href="product-category.html">Printers &#038; Ink</a></li>
                            <li class="menu-item animate-dropdown"><a title="Software"
                                    href="product-category.html">Software</a></li>
                            <li class="menu-item animate-dropdown"><a title="Office Supplies"
                                    href="product-category.html">Office Supplies</a></li>
                            <li class="menu-item animate-dropdown"><a title="Computer Components"
                                    href="product-category.html">Computer Components</a></li>
                            <li class="menu-item animate-dropdown"><a title="Car Electronic &amp; GPS"
                                    href="product-category.html">Car Electronic &#038; GPS</a></li>
                            <li class="menu-item animate-dropdown"><a title="Accessories"
                                    href="product-category.html">Accessories</a></li>
                            <li class="menu-item animate-dropdown"><a title="Printers &amp; Ink"
                                    href="product-category.html">Printers &#038; Ink</a></li>
                ...
                <ul class="navbar-mini-cart navbar-nav animate-dropdown nav pull-right flip">
                    <li class="nav-item dropdown">
                        <a href="/cart" class="nav-link" data-toggle="dropdown">
                            <i class="ec ec-shopping-bag" style="color: black;"></i>
                            <span class="cart-items-count count" style="scale: 0.8;">{{ count }}</span>
                            <span class="cart-items-total-price total-price"><span class="amount" style="color: black;">
                                    {{ total }}</span></span>
                        </a>
                                ...
                                <div class="widget_shopping_cart_content">
                                    ...
                                    <ul class="cart_list product_list_widget ">
                                        ...
                                        <li class="mini_cart_item">
                                            ...
                                            <a href="single-product.html">
                                                <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
                                                    src="assets/images/products/mini-cart1.jpg" alt="">White lumia
                                                9001&nbsp;
                                            </a>
                                        ...
                                        <li class="mini_cart_item">
                                            ...
                                            <a href="single-product.html">
                                                <img class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
                                                    src="assets/images/products/mini-cart2.jpg" alt="">PlayStation
                                                4&nbsp;
                                            </a>
