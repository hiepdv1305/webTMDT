                            ...
                            <div class="collapse navbar-toggleable-xs" id="default-header">
                                <nav>
                                    <ul id="menu-main-menu" class="nav nav-inline yamm">
                                        <li class="menu-item menu-item-has-children animate-dropdown dropdown"><a title="Home" href="/">Trang chủ</a>
                                        </li>
                                        <li class="menu-item animate-dropdown"><a title="About Us" href="/winner">Trúng thưởng</a></li>
                    ...
                    <div class="handheld-header">
                        ...
                        <div class="handheld-navigation-wrapper " :class="{ toggled: click }">
                            <div class="handheld-navbar-toggle-buttons clearfix">
                                <button class="navbar-toggler navbar-toggle-hamburger hidden-lg-up pull-right flip" @click="click=true" type="button">
                                    <i class="fa fa-bars" s></i>
                                </button>
                                <button class="navbar-toggler navbar-toggle-close hidden-lg-up pull-right flip" @click="click=false" type="button">
